      ...
      <div className="w-full lg:w-1/2 bg-white flex items-center justify-center p-6 sm:p-8">
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden mb-8">
            ...
            <p className="text-sm text-gray-600">Advanced Analytics & Financial Dashboard</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition text-gray-900 placeholder-gray-500 hover:border-gray-400"
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition text-gray-900 placeholder-gray-500 pr-12 hover:border-gray-400"
                  placeholder="••••••••"
                  disabled={isLoading}
                />
                <button
          ...
          <div className="mt-8 p-6 bg-gradient-to-br from-blue-50 via-indigo-50 to-blue-50 rounded-xl border border-blue-200 hover:border-blue-300 transition">
            <p className="text-xs font-bold text-gray-700 mb-4 uppercase tracking-wider flex items-center space-x-2">
            ...
            <div className="space-y-2 text-xs">
              <p className="text-gray-700">
                ...
                <code className="bg-white px-3 py-1.5 rounded ml-2 text-blue-600 font-mono font-medium border border-blue-200">demo@insighta.com</code>
              </p>
              <p className="text-gray-700">
                <span className="font-semibold text-gray-900">Password:</span>
                <code className="bg-white px-3 py-1.5 rounded ml-2 text-blue-600 font-mono font-medium border border-blue-200">demo123</code>
              </p>
            </div>
          </div>
